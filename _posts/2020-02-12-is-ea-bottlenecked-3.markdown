...
[^13]: I approched with questions on DS and they informed me that they
    ...
    make the cut. What I asked?
	
	- Do I gain sufficient skills to migrate to Direct work (say analyst
...
[^14]: 
	...
	> ... following list for SF area: 80khours (SF, Oxford), GiveWell (San
	...
	> Sightsavers (U.K), Founders Pledge (London).

	> The following for other areas: Evidence Action (Washington DC),
	...
	> So for the EA community it looks like the clustering does happen in
	> UK (Oxford, London) and San Francisco area. These regions are the
	> only regions that host the annual EA conferences, not surprisingly.


[^15]:

	2012: They seem to be suggesting [here](https://80000hours.org/2012/01/just-what-is-making-a-difference-counterfactuals-and-career-choice/) while talking about
	...
	2014: They went on to suggest that [replaceability might not be as
	important as you might think](https://80000hours.org/2015/07/replaceability-isnt-as-important-as-you-might-think-or-weve-suggested/). In 2017 they seem to continue to
	promote that idea in "[Working at effective altruist
	organizations](https://80000hours.org/career-reviews/working-at-effective-altruist-organisations/#but-wont-i-be-replaceable)".

	In 2019 article on "[how replaceable are top candidates in large
	hiring rounds](https://80000hours.org/2019/08/how-replaceable-are-top-candidates-in-large-hiring-rounds/)", they seem to suggest that it depends on the type
	of distribution of the candidates (log normal or normal).

[^16]: 

	Claim: "If you get involved in the community, and prove your interest
	and general competence, there’s a *decent chance* you’ll be able to
	find a role regardless of your qualifications and experience."

	Example: [EA applicant](https://forum.effectivealtruism.org/posts/jmbP9rwXncfa32seH/after-one-year-of-applying-for-ea-jobs-it-is-really-really) from EA forum.

	He applied to 20 jobs. He didn't get a single job, neither did his
	friends--with the characteristics as above-- get jobs. His
	[profile](https://drive.google.com/file/d/1E8DLudgTYxJcESvhSdozgA36LQU0oMnN/view?usp=sharing) seems to match the one in the claim.

	**Note**: The claim says "decent chance" and not "for sure" though. I
	give them that. Although many people seem interpret it differently.

[^17]: 

	"If you get involved in the community, and prove your interest and
	general competence, there’s a decent chance you’ll be able to find a
	role regardless of your qualifications and experience." --- [80k](https://80000hours.org/career-reviews/working-at-effective-altruist-organisations/#how-to-assess-your-personal-fit)

	This seems to imply to me that people like [EA applicant](https://forum.effectivealtruism.org/posts/jmbP9rwXncfa32seH/after-one-year-of-applying-for-ea-jobs-it-is-really-really) should
	have gotten a job. But he didn't. I think examples would be much
	better to understand what they mean. What does decent chance mean?
