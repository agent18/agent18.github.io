...
### EA orgs are able to find people for their orgs
1.

**Claim**: EA Orgs seem to be able to hire the number of people they
want, at the end of the hiring round* be it in research or
operations.

**re-write Claim**: EA Orgs are able to hire the number of people *they
set out to hire* at the end of hiring round, in research.

**Subject**: EA Orgs at the end of hiring rounds, in research

**Predicate**:  are able to hire the number of people they set out to.

**Example**: OPP set out to hire 5 GR's in the beginning of 2018 and
succeeded in it by the end of 2018

~~**Example 2**: RP saying, "I've certainly had no problem finding
junior staff for Rethink Priorities"~~

**Definition**: Example matches the definition.

**Checklist**: T/F; sub-Yes; pre-**No**; ecm-Yes; s-1;

*Set out to hire* seems testable. *Want* also seems good enough. Any
comments here? 

Should we provide examples for "set out to hire" such as a previous
year "plan" where it states, "we want to hire X number of people", or
can we simply infer that with the number of people in the 

add link to "set out to hire." It could be any

I don't know if the example I have presented is good or not. This is
really sad. So let's go back to subject and predicate.

We are looking for EE and not op-eds.
...
**Re-write claim**: The number of people at the end of hiring round
for entrepreneurs is equal to ~~what the EA orgs set out to hire~~
what they claimed they would in the plan of that year. (OMG, Did I do
it!)

**Subject**: The number of people hired at the end of the hiring round
for entrepreneurs

**Predicate**: are what the orgs explicitly expected in their yearly plan.

**Example**: CE's recent hiring round shows that 17 people were
accepted while they wanted to hire 20 people.
