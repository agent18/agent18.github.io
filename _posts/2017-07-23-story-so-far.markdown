...
This probably seems like a nice time to start questioning if feelings might actually give us reliable and consistent results. When the brain cant understand the difference between 100,000 people and 1,000,000 people when it sees them, when the brain can't understand the difference between 10,000 hairs and 100,000 hairs (Simple test: How many 1000 hairs do you think you have? and then [Google][]), When the brain evolved in a setting where there were far less people in its tribe, could it still be that option b is right? We can't imagine the large numbers or for that matter the difference between 10,000 or 100,000 hairs, other than that it is somehow "much larger". In addition, knowing some of the heuristics that the brain uses, such as the sugar urge, social proof and the like, to compute things cheaply [[citation needed][]], the level and capability of the brain should be clear. 
...
#### Feelings(intuition) as only direction point (Options)
...
What are my other options anyway? I could probably let someone very wise to let me know what I should do. But whether I do it or not would still be in consultation with my current system ([solution inside my head][]). For example, if the wise man told you to chop someones head off, you would not do it right! And how do you determine he is wise in the first place! Let me give you a hint? ;) ([solution inside my head][])
...
I've read Eleizer's post on [intuition][ele_intuitions] many times but suddenly when I was writing is when it slowly started to make sense. So Shut up and write!
